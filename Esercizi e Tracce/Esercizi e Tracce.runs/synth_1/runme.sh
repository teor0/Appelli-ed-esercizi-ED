...
HD_PWD='D:/Esercizi vivado/Esercizi e Tracce/Esercizi e Tracce.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux8_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux8_1.tcl
